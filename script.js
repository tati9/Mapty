...
const cycling1 = new Cycling([39, -12], 5.2, 24, 580);
console.log(run1, cycling1);

// Application Architactore
class App {
  #map;
  #mapEvent;
  #mapZoomLevel = 13;
  ...
  _loadMap(position) {
    ...
    // load markers form local storage
  ...
  _newWorkout(e) {
    ...
    if (type === 'running') {
      ...
      if (
        ...
        return alert('Inputs have a not a number');
